...
$(document).ready(
		function() {
			...
			$("#last_enrolmain0").click(function() {
				var query = {
						encode : $("#encode0").val()
					};
			...
			$("#last_enrolmain1").click(function() {
			...
			$("#last_enrolmain2").click(function() {
				var query = {
						encode : $("#encode2").val()
					};
			...
			$("#last_enrolmain3").click(function() {
				var query = {
						encode : $("#encode3").val()
					};
			...
			$("#last_enrolmain4").click(function() {
				var query = {
						encode : $("#encode4").val()
					};
			...
			$("#last_enrolmain5").click(function() {
				var query = {
						encode : $("#encode5").val()
					};
			...
			$("#last_enrolmain6").click(function() {
				var query = {
						encode : $("#encode6").val()
					};
			...
			$("#last_enrolmain7").click(function() {
				var query = {
						encode : $("#encode7").val()
					};
